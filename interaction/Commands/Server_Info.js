...
const { server_status_database_commands } = require(`../../commands_modules/server-status/ss_databaseFunctionManager.js`);
...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const userCount = interaction.guild.members.cache.filter(member => !member.user.bot).size;
        ...
        const guildIcon = interaction.guild.iconURL() || 'https://cdn.discordapp.com/attachments/876461907840745513/1089581164752273468/404-error-icon-vector-symbol-260nw-1545236357_1.png';
        ...
        commands.update_Guild_Collection_Database(guildId, guildName, ownerId, allMemberCount, userCount, Bots_Count, maximumBitrate, preferredLocale, createdAt, premiumTier, premiumSubscriptionCount, nsfwLevel, partnered);
