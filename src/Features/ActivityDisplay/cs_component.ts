...
class ServerStatusIds {
  All_Members_Count_Id: any;
  All_Offline_Count_Id: any;
  All_Online_Count_Id: any;
  All_Online_Count_include_idle_Id: any;
  All_Online_Count_include_idle_dnd_Id: any;
  Bots_Count_Id: any;
  Category_Id: any;
  User_Id: any;
  User_Idle_Count_Id: any;
  User_Offline_Count_Id: any;
  User_Online_Count_Id: any;
  User_Online_Count_include_idle_Id: any;
  User_Online_Count_include_idle_dnd_Id: any;
  Users_Count_Id: any;
  dateTime: any;
  guild_id: any;
  selectMenu_Values: any;
  ServerStatusIds() {
    this.guild_id = "";
    this.Category_Id = "";
