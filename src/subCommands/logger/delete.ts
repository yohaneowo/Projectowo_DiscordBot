          ...
          switch (value) {
            case "0": {
              ...
              if (channelCreate_Channel) {
                await channelCreate_Channel
                  .delete()
                  .then(() => {
                    console.log(`成功刪除頻道 ${channelCreate_Channel.name}`)
                  })
                  .catch((error) => {
                    console.error(
                      `刪除頻道 ${channelCreate_Channel.name} 時發生錯誤：`,
                      error
                    )
                  })
              } else {
            ...
            case "1": {
              ...
              if (channelUpdate_Channel) {
                await channelUpdate_Channel
                  .delete()
                  .then(() => {
                    console.log(`成功刪除頻道 ${channelUpdate_Channel.name}`)
                  })
                  .catch((error) => {
                    console.error(
                      `刪除頻道 ${channelUpdate_Channel.name} 時發生錯誤：`,
                      error
                    )
                  })
              } else {
            ...
            case "2": {
              ...
              if (channelDelete_Channel) {
                await channelDelete_Channel
                  .delete()
                  .then(() => {
                    console.log(`成功刪除頻道 ${channelDelete_Channel.name}`)
                  })
                  .catch((error) => {
                    console.error(
                      `刪除頻道 ${channelDelete_Channel.name} 時發生錯誤：`,
                      error
                    )
                  })
              } else {
            ...
            case "3": {
              ...
              if (guildBanAdd_Channel) {
                await guildBanAdd_Channel
                  .delete()
                  .then(() => {
                    console.log(`成功刪除頻道 ${guildBanAdd_Channel.name}`)
                  })
                  .catch((error) => {
                    console.error(
                      `刪除頻道 ${guildBanAdd_Channel.name} 時發生錯誤：`,
                      error
                    )
                  })
              } else {
            ...
            case "4": {
              ...
              if (guildBanRemove_Channel) {
                await guildBanRemove_Channel
                  .delete()
                  .then(() => {
                    console.log(`成功刪除頻道 ${guildBanRemove_Channel.name}`)
                  })
                  .catch((error) => {
                    console.error(
                      `刪除頻道 ${guildBanRemove_Channel.name} 時發生錯誤：`,
                      error
                    )
                  })
              } else {
            ...
            case "5": {
              ...
              if (guildRoleCreate_Channel) {
                await guildRoleCreate_Channel
                  .delete()
                  .then(() => {
                    console.log(`成功刪除頻道 ${guildRoleCreate_Channel.name}`)
                  })
                  .catch((error) => {
                    console.error(
                      `刪除頻道 ${guildRoleCreate_Channel.name} 時發生錯誤：`,
                      error
                    )
                  })
              } else {
            ...
            case "6": {
              ...
              if (guildRoleDelete_Channel) {
                await guildRoleDelete_Channel
                  .delete()
                  .then(() => {
                    console.log(`成功刪除頻道 ${guildRoleDelete_Channel.name}`)
                  })
                  .catch((error) => {
                    console.error(
                      `刪除頻道 ${guildRoleDelete_Channel.name} 時發生錯誤：`,
                      error
                    )
                  })
              } else {
            ...
            case "7": {
              ...
              if (guildRoleUpdate_Channel) {
                await guildRoleUpdate_Channel
                  .delete()
                  .then(() => {
                    console.log(`成功刪除頻道 ${guildRoleUpdate_Channel.name}`)
                  })
                  .catch((error) => {
                    console.error(
                      `刪除頻道 ${guildRoleUpdate_Channel.name} 時發生錯誤：`,
                      error
                    )
                  })
              } else {
            ...
            case "8": {
              ...
              if (guildUpdate_Channel) {
                await guildUpdate_Channel
                  .delete()
                  .then(() => {
                    console.log(`成功刪除頻道 ${guildUpdate_Channel.name}`)
                  })
                  .catch((error) => {
                    console.error(
                      `刪除頻道 ${guildUpdate_Channel.name} 時發生錯誤：`,
                      error
                    )
                  })
              } else {
            ...
            case "9": {
              ...
              if (messageDelete_Channel) {
                await messageDelete_Channel
                  .delete()
                  .then(() => {
                    console.log(`成功刪除頻道 ${messageDelete_Channel.name}`)
                  })
                  .catch((error) => {
                    console.error(
                      `刪除頻道 ${messageDelete_Channel.name} 時發生錯誤：`,
                      error
                    )
                  })
              } else {
            ...
            case "10": {
              ...
              if (messageDeleteBulk_Channel) {
                await messageDeleteBulk_Channel
                  .delete()
                  .then(() => {
                    console.log(
                      `成功刪除頻道 ${messageDeleteBulk_Channel.name}`
                    )
                  })
                  .catch((error) => {
                    console.error(
                      `刪除頻道 ${messageDeleteBulk_Channel.name} 時發生錯誤：`,
                      error
                    )
                  })
              } else {
            ...
            case "11": {
              ...
              if (messageUpdate_Channel) {
                await messageUpdate_Channel
                  .delete()
                  .then(() => {
                    console.log(`成功刪除頻道 ${messageUpdate_Channel.name}`)
                  })
                  .catch((error) => {
                    console.error(
                      `刪除頻道 ${messageUpdate_Channel.name} 時發生錯誤：`,
                      error
                    )
                  })
              } else {
            ...
            case "12": {
              ...
              if (guildMemberAdd_Channel) {
                await guildMemberAdd_Channel
                  .delete()
                  .then(() => {
                    console.log(`成功刪除頻道 ${guildMemberAdd_Channel.name}`)
                  })
                  .catch((error) => {
                    console.error(
                      `刪除頻道 ${guildMemberAdd_Channel.name} 時發生錯誤：`,
                      error
                    )
                  })
              } else {
            ...
            case "13": {
              ...
              if (guildMemberKick_Channel) {
                await guildMemberKick_Channel
                  .delete()
                  .then(() => {
                    console.log(`成功刪除頻道 ${guildMemberKick_Channel.name}`)
                  })
                  .catch((error) => {
                    console.error(
                      `刪除頻道 ${guildMemberKick_Channel.name} 時發生錯誤：`,
                      error
                    )
                  })
              } else {
            ...
            case "14": {
              ...
              if (guildMemberRemove_Channel) {
                await guildMemberRemove_Channel
                  .delete()
                  .then(() => {
                    console.log(
                      `成功刪除頻道 ${guildMemberRemove_Channel.name}`
                    )
                  })
                  .catch((error) => {
                    console.error(
                      `刪除頻道 ${guildMemberRemove_Channel.name} 時發生錯誤：`,
                      error
                    )
                  })
              } else {
            ...
            case "15": {
              ...
              if (guildMemberUpdate_Channel) {
                await guildMemberUpdate_Channel
                  .delete()
                  .then(() => {
                    console.log(
                      `成功刪除頻道 ${guildMemberUpdate_Channel.name}`
                    )
                  })
                  .catch((error) => {
                    console.error(
                      `刪除頻道 ${guildMemberUpdate_Channel.name} 時發生錯誤：`,
                      error
                    )
                  })
              } else {
            ...
            case "16": {
              ...
              if (guildMemberNickUpdate_Channel) {
                await guildMemberNickUpdate_Channel
                  .delete()
                  .then(() => {
                    console.log(
                      `成功刪除頻道 ${guildMemberNickUpdate_Channel.name}`
                    )
                  })
                  .catch((error) => {
                    console.error(
                      `刪除頻道 ${guildMemberNickUpdate_Channel.name} 時發生錯誤：`,
                      error
                    )
                  })
              } else {
            ...
            case "17": {
              ...
              if (voiceChannelLeave_Channel) {
                await voiceChannelLeave_Channel
                  .delete()
                  .then(() => {
                    console.log(
                      `成功刪除頻道 ${voiceChannelLeave_Channel.name}`
                    )
                  })
                  .catch((error) => {
                    console.error(
                      `刪除頻道 ${voiceChannelLeave_Channel.name} 時發生錯誤：`,
                      error
                    )
                  })
              } else {
            ...
            case "18": {
              ...
              if (voiceChannelJoin_Channel) {
                await voiceChannelJoin_Channel
                  .delete()
                  .then(() => {
                    console.log(`成功刪除頻道 ${voiceChannelJoin_Channel.name}`)
                  })
                  .catch((error) => {
                    console.error(
                      `刪除頻道 ${voiceChannelJoin_Channel.name} 時發生錯誤：`,
                      error
                    )
                  })
              } else {
            ...
            case "19": {
              ...
              if (voiceStateUpdate_Channel) {
                await voiceStateUpdate_Channel
                  .delete()
                  .then(() => {
                    console.log(`成功刪除頻道 ${voiceStateUpdate_Channel.name}`)
                  })
                  .catch((error) => {
                    console.error(
                      `刪除頻道 ${voiceStateUpdate_Channel.name} 時發生錯誤：`,
                      error
                    )
                  })
              } else {
            ...
            case "20": {
              ...
              if (voiceChannelSwitch_Channel) {
                await voiceChannelSwitch_Channel
                  .delete()
                  .then(() => {
                    console.log(
                      `成功刪除頻道 ${voiceChannelSwitch_Channel.name}`
                    )
                  })
                  .catch((error) => {
                    console.error(
                      `刪除頻道 ${voiceChannelSwitch_Channel.name} 時發生錯誤：`,
                      error
                    )
                  })
              } else {
            ...
            case "21": {
              ...
              if (guildEmojisUpdate_Channel) {
                await guildEmojisUpdate_Channel
                  .delete()
                  .then(() => {
                    console.log(
                      `成功刪除頻道 ${guildEmojisUpdate_Channel.name}`
                    )
                  })
                  .catch((error) => {
                    console.error(
                      `刪除頻道 ${guildEmojisUpdate_Channel.name} 時發生錯誤：`,
                      error
                    )
                  })
              } else {
